...
*______________________________________________________*
                                              *[ DONASI ]*
    Dana/Gopay: 6288221400832
    Saweria: https://saweria.co/Ekadanuarta
    Smart: 6288221400832
*===========================================*  
ᛃ LIST MENU ᛃ
...
Beli VIP: https://wa.me/6288221400832?text=bang+beli+vip+bot
`
}
...
function info() {
  return `Hai, perkenalkan saya *tes-bot* sebuah robot chat autorespon yang di buat menggunakan *NodeJS* dengan berbagai fitur menarik.
...
Instagram: www.instagram.com/ekagans_02/
...
exports.info = info()
function snk() {
  return `Syarat dan Ketentuan Bot *Tes WaBot*
