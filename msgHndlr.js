...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = '6288221400832@c.us'
...
\`\`\`TIDAK ADA PERKULIAHAN\`\`\`
        ...
        } else if (detectThis.includes('hai') || detectThis.includes('bot') || detectThis.includes('oi') || detectThis.includes('p') || mentionedJidList.includes('6288221400832@c.us')) {
